...
describe('service worker', () => {
  ...
  it('keeps timetable data out of the install-time cache payload', async () => {
    ...
    expect(cachedUrls).toContain('./src/lib/ads.js?v=11');
    expect(cachedUrls).toContain('./src/lib/installAdSense.js');
    expect(cachedUrls).toContain('./src/lib/installAdSense.js?v=11');
  ...
  it('precaches the versioned app shell requested by index.html', async () => {
    ...
    expect(cachedUrls).toContain('./styles.css?v=11');
    expect(cachedUrls).toContain('./src/main.js?v=11');
    expect(cachedUrls).toContain('./src/lib/analytics.js?v=11');
    expect(cachedUrls).toContain('./src/ui/renderSearchForm.js?v=11');
